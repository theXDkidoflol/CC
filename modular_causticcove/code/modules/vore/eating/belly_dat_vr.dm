...
/datum/belly
	...
	var/vore_sound = 'modular_causticcove/sound/vore/pred/swallow_01.ogg'	// Sound when ingesting someone
...
//	var/silenced = FALSE					// Will the heartbeat/fleshy internal loop play?
	...
	var/tmp/list/digest_modes = list(DM_HOLD,DM_DIGEST,DM_HEAL,DM_NOISY,DM_MANABURN,DM_STRONGDIGEST)	// Possible digest modes
